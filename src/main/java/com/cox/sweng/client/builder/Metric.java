 ...
 */
package com.cox.sweng.client.builder;

import static com.cox.sweng.client.util.Preconditions.checkNotNullOrEmpty;
...
public class Metric {
	...
	public Metric setDataPoint(Long object, Float averageLatency) {
		return innerAddDataPoint(object, averageLatency);
	}
